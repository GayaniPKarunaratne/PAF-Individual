...
public class PatientsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = patientObj.insertPatient(request.getParameter("patientName"),
				request.getParameter("patientAddress"), request.getParameter("patientAge"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = patientObj.updatePatient(paras.get("hidPatientIDSave").toString(), paras.get("patientName").toString(),
				paras.get("patientAddress").toString(), paras.get("patientAge").toString(), paras.get("patientPhone").toString());
		response.getWriter().write(output);
	}
